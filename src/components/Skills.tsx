...
const Skills = () => {
  ...
  const skillCategories = [
    { title: "UX/UI Design", skills: [{ name: "Figma", level: 95 }, { name: "User Research", level: 90 }, { name: "Prototipagem", level: 95 }, { name: "Design Thinking", level: 90 }, { name: "Service Design", level: 85 }, { name: "Usabilidade", level: 90 }] },
    { title: "Inteligência Artificial", skills: [{ name: "IA aplicada a Design", level: 85 }, { name: "Análises Estratégicas", level: 80 }, { name: "Geração de Insights", level: 85 }, { name: "Machine Learning", level: 70 }, { name: "Data Analysis", level: 75 }, { name: "AI Ethics", level: 80 }] },
    { title: "VR/AR & 3D", skills: [{ name: "Unity 3D", level: 90 }, { name: "Blender", level: 85 }, { name: "Realidade Virtual", level: 95 }, { name: "Realidade Aumentada", level: 85 }, { name: "Digitalização 3D", level: 90 }, { name: "Impressão 3D", level: 85 }] },
    { title: "Desenvolvimento & Tecnologia", skills: [{ name: "React Native", level: 80 }, { name: "C#", level: 75 }, { name: "HTML/CSS", level: 85 }, { name: "JavaScript", level: 75 }, { name: "Prototipagem Rápida", level: 90 }, { name: "Workshop Facilitation", level: 95 }] }
  ];
    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={titleRef} className={`text-center mb-16 scroll-reveal ${titleVisible ? 'visible' : ''}`}>
          <h2 className="text-4xl font-bold text-foreground mb-4">Skills & Tecnologias</h2>
                  ...
                  {category.skills.map((skill, idx) => (
                    <div key={idx}>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-muted-foreground/70 text-sm">{skill.level}%</span>
                      </div>
