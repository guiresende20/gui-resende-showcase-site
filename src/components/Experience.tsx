      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-l-4 border-l-blue-900">
              <CardHeader>
              ...
              <CardContent>
                ...
                {/* Thumbnails for Anglo Vestibulares */}
                {exp.thumbnails && (
                  <div className="mt-6">
                ...
                {/* Video link for Campus Party */}
                {exp.videoLink && (
                  <div className="mt-6">
                    <button
                      onClick={() => handleVideoClick(exp.videoLink)}
                      className="flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors"
                    >
                      <Play size={16} />
                      Vídeo do Evento Campus Party
